...
Raygun raygun_ipfs_temporary(MultiPass account) {
    Pointer<G_RgIpfsConfig> config = _raygun_ipfs_bindings.rg_ipfs_config_testing();
...
Raygun raygun_ipfs_persistent(MultiPass account, String path) {
    ...
    G_FFIResult_RayGunAdapter result =
    _raygun_ipfs_bindings.warp_rg_ipfs_persistent_new(
        account.pointer, nullptr, config.data);
